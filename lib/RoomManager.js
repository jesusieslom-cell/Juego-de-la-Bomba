  ...
  createRoom(socketId, name, token) {
    ...
    const room = {
      ...
      settings: {
        ...
        minWordLen: 2,
        fragLen: 'random',
        // fragWeights: percentage for len2 and len4, len3 is remainder
        fragWeight2Pct: 10,
        fragWeight4Pct: 10,
        // how many recent fragments to avoid repeating
        recentFragMemory: 20,
        // grace period (ms) allowed for reconnecting when it's your turn
        disconnectGraceMs: 2000,
        noRepeat: true,
        turnMode: 'RANDOM' // 'RANDOM' or 'LINEAR'
      },
      players: [{
        id: socketId,
        name,
      ...
      turnTimer: null,
      disconnectTimers: {},
      randomTurnBag: [], // For RANDOM FAIR
      lastPlayerTurnId: null // To keep track for LINEAR and avoid immediate repeats in RANDOM
    };
